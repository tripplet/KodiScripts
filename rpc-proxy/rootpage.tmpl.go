...
// GENERATED: 2017-09-03 13:01:56.482127248 +0200 CEST
...
<head>
  ...
  <script>
    function resetForm(progress, button, link, in_progress) {
      if (in_progress) {
    ...
    function sendUrl() {
      ...
      resetForm(progress, button, link, true);
      ...
      fetch("/jsonrpc", {
        ...
        resetForm(progress, button, link, false);
        link.value = "";
      }).catch(function(err) {
        resetForm(progress, button, link, false);
        alert(err);
